                ...
                <div className="flex flex-wrap gap-2">
                    ...
                    {selectedId && (
                        <button
                            ...
                            disabled={saving}
                            className="inline-flex items-center gap-2 px-4 py-2.5 bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 font-medium rounded-xl hover:bg-red-100 dark:hover:bg-red-900/30 transition-all disabled:opacity-50"
                        >
                            ...
                            <tbody className="divide-y divide-slate-100 dark:divide-slate-700">
                                {usuarios.map((usuario) => (
                                    <tr
                                        ...
                                        className={`cursor-pointer transition-colors ${selectedId === usuario.id
